...
function modelh= HXTmodel601L(params, mediaInput)
...
V2mRNA=params(13)/VmRNA;
 ...
 DmRNA= VmRNA*(Glucose)^hillmRNA /(KmRNA^hillmRNA+Glucose^hillmRNA)+ (V2mRNA/(1+(Glucose^hill2mRNA/K2mRNA^hill2mRNA)))-KdegmRNA*mRNA;
