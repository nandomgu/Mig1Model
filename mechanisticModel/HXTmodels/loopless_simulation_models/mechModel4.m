...
function modelh= mechModel4(params, args)

description='mechModel4-similar to model 3 but STD1 explicitly represses the HXT.- Mth1 is degraded glucose, glucose -> nuclear mig1; Mth1 is NOT repressed by Mig1Std1 is degraded by glucoseStd1 induces delocalisation of Mig1 mig1, mth1 repress th hxt, hxt is degraded in the absence of glucose ';
...
DHXT=  VHXT/ (1+ (STD1/KrepHST)^hillHST+ (MIG1/KrepHMG)^hillHMG +(MTH1/KrepHMT)^hillHMT) - deg*HXT;
