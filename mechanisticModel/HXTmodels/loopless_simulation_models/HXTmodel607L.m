...
function modelh= HXTmodel607L(params, mediaInput)
...
DmRNA=VmRNA/(1+(rep1^hillmRNA/KmRNA^hillmRNA)+(rep2^hill2mRNA/K2mRNA^hill2mRNA)) - KdegmRNA*mRNA;

degHXT= maxdegHXT*(Glucose)^hillDegHXT /(degThreshHXT^hillDegHXT+Glucose^hillDegHXT);

 
 DHXT= alphaHXT*mRNA -degHXT*HXT  ;
