...
function modelh= mechModel2(params, args)

description='mechModel2- Mth1 is degraded glucose, glucose -> nuclear mig1; mig1 represses mth1, mig1, mth1 repress hxt, hxt is degraded in the absence of glucose ';
...
hillMG=params(16);
VdegHXT=params(17);
threshdegHXT=params(18);
hilldegHXT=params(19);
