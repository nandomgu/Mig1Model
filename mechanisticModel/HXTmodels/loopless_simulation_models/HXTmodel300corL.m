...
function modelh= HXTmodel300corL(params, mediaInput)
...
DMth1= VMth1-  (maxdegMth1/(1+(snf3Gate^hillDegMth1/KdegMth1^hillDegMth1)))*Mth1;
DStd1= VStd1-  (maxdegStd1*(rgt2Gate^hillDegStd1)/(KdegStd1^hillDegStd1+rgt2Gate^hillDegStd1))*Std1;
