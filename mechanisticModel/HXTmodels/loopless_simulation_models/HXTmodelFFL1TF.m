...
function modelh= HXTmodelFFL1TF(params, mediaInput)
%%Model FFL1 is simple threshold-activated production of a secondary gene, activated by a TF named HXT.  including the
