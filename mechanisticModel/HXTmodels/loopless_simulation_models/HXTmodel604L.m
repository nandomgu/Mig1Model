...
function modelh= HXTmodel604L(params, mediaInput)
...
V2mRNA=params(13);
 ...
 DmRNA= VmRNA*(Glucose)^hillmRNA /(KmRNA^hillmRNA+Glucose^hillmRNA)+ (V2mRNA/(1+(Glucose^hillmRNA/K2mRNA^hill2mRNA)))-KdegmRNA*mRNA;
 ...
 dout(1)=DmRNA;
 dout(2)=DHXT;
 dout(3)=DMatureHXT*HXT-(KBleach*MatureHXT)- (maxdegHXT*(Glucose)^hillmRNA /(KmRNA^hillmRNA+Glucose^hillmRNA)*MatureHXT);
