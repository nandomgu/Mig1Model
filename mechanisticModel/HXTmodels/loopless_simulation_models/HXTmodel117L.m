...
function modelh= HXTmodel117L(params, mediaInput)
...
DMth1= maxVMth1-  (sensorRatio*rgt2Gate* maxdegMth1)*Mth1-(1-sensorRatio*snf3Gate* maxdegMth1)*Mth1;
DStd1= maxVStd1- (sensorRatio*rgt2Gate* maxdegStd1)*Std1-(1-sensorRatio*snf3Gate* maxdegStd1)*Std1;
