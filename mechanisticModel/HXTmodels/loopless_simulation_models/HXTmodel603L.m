...
hill2mRNA=params(12);
 ...
 DmRNA= ((VmRNA*(Glucose)^hillmRNA /(KmRNA^hillmRNA+Glucose^hillmRNA))/(1+(Glucose^hill2mRNA/K2mRNA^hill2mRNA)))- KdegmRNA*mRNA;
 

DHXT= (alphaHXT/(1+(Glucose^hillDegHXT/degThreshHXT^hillDegHXT)))*mRNA-  ((maxdegHXT/(1+(Glucose/degThreshHXT)^hillDegHXT))*HXT);
