...
function modelh= HXTmodel300L(params, mediaInput)
%%Loopless models also receive the media Input in the model handle setup,
%%and can be run immediately with ode23
