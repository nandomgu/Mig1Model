...
function modelh= HXTmodel1162L(params, mediaInput)
...
DMth1= VMth1-  (maxdegMth1/(1+(Glucose^hillDegMth1/KdegMth1^hillDegMth1)))*Mth1;
DStd1= VStd1-  (maxdegStd1*(Glucose^hillDegStd1/KdegStd1^hillDegStd1+Glucose^hillDegStd1))*Std1;
