...
include("cgenotypes3.jl")
#Model 3. removing std1- snf1 interaction 

function makeproblem3(modelfile, inputx, inputy, concentration, t, h0, genotype = wt)
    ...
    function modelg3(input)
    
    
        function model3(dydt, y, parameters, t)
    ...
    prob3(params) = ODEProblem(modelg3(input), [h0;0.0;0.0;exp.(genotype(params)[[end-2, end-1]]);0.0], t, [exp(j) for j in genotype(params)])
