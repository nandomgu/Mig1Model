...
function makeproblem6(modelfile, inputx, inputy, concentration, t, h0, genotype = wt)
    ...
    function modelg6(input)
    
    
        function model6(dydt, y, parameters, t)
    ...
    prob6(params) = ODEProblem(modelg6(input), [h0;0.0;0.0;exp.(genotype(params)[[end-2, end-1]]);0.0], t, [exp(j) for j in genotype(params)])
