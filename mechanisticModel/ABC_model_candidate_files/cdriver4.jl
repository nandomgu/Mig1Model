...
include("cgenotypes4.jl")
#Model 3. removing std1- snf1 interaction and std1-mig2 interaction

function makeproblem4(modelfile, inputx, inputy, concentration, t, h0, genotype = wt)
    ...
    function modelg4(input)
    
    
        function model4(dydt, y, parameters, t)
    ...
    prob4(params) = ODEProblem(modelg4(input), [h0;0.0;0.0;exp.(genotype(params)[[end-2, end-1]]);0.0], t, [exp(j) for j in genotype(params)])
