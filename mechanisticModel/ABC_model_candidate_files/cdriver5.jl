...
include("cgenotypes5.jl")
#Model 3. removing std1- snf1 interaction and mig -mth1 interaction

function makeproblem5(modelfile, inputx, inputy, concentration, t, h0, genotype = wt)
    ...
    function modelg5(input)
    
    
        function model5(dydt, y, parameters, t)
    ...
    prob5(params) = ODEProblem(modelg5(input), [h0;0.0;0.0;exp.(genotype(params)[[end-2, end-1]]);0.0], t, [exp(j) for j in genotype(params)])
