...
function makeproblem(modelfile, inputx, inputy, concentration, t, h0, genotype = wt)
    ...
    function modelg(input)
        ...
        function model(dydt, y, parameters, t)
            ...
            Mig1 = y[2] 
            Mig2 = y[3] 
            Mth1 = y[4] #parameters[49]
            Std1 = y[5] #parameters[50]
            y[6] = g
    ...
    prob(params) = ODEProblem(modelg(input), [h0;0.0;0.0;exp.(genotype(params)[49:50]);0.0], t, [exp(j) for j in genotype(params)[1:48]])
