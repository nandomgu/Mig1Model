...
function model(dydt, y, parameters, t)
	...
	dydt[1]= +(shxt4/(1 + (Mth1/khxt4mth1)^nhxt4mth1 + (Std1/khxt4std1)^nhxt4std1 + (Mth1*Std1/ khxt4mth1std1)^nhxt4mth1std1))-dhxt4*Hxt4-(dhxt4max/(1 + (g/kdhxt4)^ndhxt4)*Hxt4)
	dydt[2]= +(imig1*(mig1tot - Mig1))-(emig1max*Snf1*Mig1/(kmig1snf1 + Mig1))
